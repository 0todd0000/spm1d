...
class FraminghamSystolicBloodPressure(_base.DatasetCIpaired):
	def _set_values(self):
		...
		self.YA       = np.array([168, 111, 139, 127, 155, 115, 125, 123, 130, 137, 130, 129, 112, 141, 122])
		self.YB       = np.array([141, 119, 122, 127, 125, 123, 113, 106, 131, 142, 131, 135, 119, 130, 121])
		self.alpha    = 0.05
		self.mu       = 0
		self.ci       = (-12.4, 1.8)
