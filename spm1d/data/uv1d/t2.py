...
class SmallSampleLargePosNegEffects(_base.DatasetT2, _base.Dataset1D):
    def _set_values(self):
        self.datafile = os.path.join(_base.get_datafilepath(), 'SmallSampleLargePosNegEffects.npy')
        ...
        self.df       = None
        self.p        = None
        self.www      = 'https://github.com/0todd0000/spm1d/issues/307'
        self.note     = 'Note     ', 'Thank you Jeremy!'
