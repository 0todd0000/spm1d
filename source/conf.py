# -*- coding: utf-8 -*-
#
# spm1d documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'spm1d.tex', u'spm1d Documentation',
     u'Todd Pataky', 'manual'),
]
...
man_pages = [
    (master_doc, 'spm1d', u'spm1d Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'spm1d', u'spm1d Documentation',
     author, 'spm1d', 'One line description of project.',
     'Miscellaneous'),
]
